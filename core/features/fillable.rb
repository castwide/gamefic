...
class Context
	CONTAINER = Context.new("container", [:children, [:parent, :children], Fillable])
end

Action.new("drop_in", Context::CONTAINER, Context::CHILDREN) { |actor, container, object|
...
Action.new("take_from", Context::CONTAINER, Context::STRING) { |actor, container, object|
...
Action.new("look", Context::CONTAINER) { |actor, container|
