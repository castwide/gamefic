...
describe "Restaurant (Web)", :type => :feature, :js => true do
  ...
  it "concludes web game with test me" do
    config = Gamefic::Sdk::Config.new('examples/restaurant', { 'target_path' => "#{@dir}/targets", 'build_path' => "#{@dir}/builds", "libraries" => ["standard"], 'import_path' => Gamefic::Sdk::GLOBAL_SCRIPT_PATH })
